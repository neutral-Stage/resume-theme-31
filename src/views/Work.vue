      ...
      <v-col md="10" sm="12">
        <v-row justify="center">
          <v-col md="6" sm="12" cols="12" v-for="n in 4" :key="n">
            <v-row
              justify="start"
              class="layer ma-md-4 py-md-6 ma-xs-2 py-xs-3"
              no-gutters
            >
              <v-col cols="2" md="12" class="pl-md-6 pl-xs-3">
                <v-btn
                  fab
                  elevation="0"
                  class="workicon"
                  style="background: linear-gradient(92.67deg, #F9BFDA 1.07%, #FFCAD0 51.95%, #FDBEBA 89.88%);"
                >
                  <v-img :src="temp.icon" class="iconimg" contain></v-img>
                </v-btn>
              </v-col>
              <v-row class="pl-md-12 ml-12 mt-xs-n8 pl-xs-6 mt-md-4" no-gutters>
                ...
                <v-col md="8" sm="7" cols="12" class="text-md-center pr-md-12 ">
                  <h1 class=" subtitle-2 pb-2 mr-12" style="color:#F97CB3;">
                    {{ temp.sub }}
                  </h1>
                </v-col>
                <v-row class="pr-6 mt-md-8 pb-6">
                  <v-col md="3" sm="3" cols="12">
                    <h1 class="d-inline-block subtitle-2">Duration :</h1>
                    <h1
                  ...
                  <v-col
                    ...
                    sm="7"
                    cols="12"
                    class=" px-md-12 pb-12 pr-xs-12"
                  >
                    <h1 class="textcol sfont pb-2 font-weight-thin">
                      {{ temp.para }}
                    </h1>
                  </v-col>
                </v-row>
...
@media only screen and (max-width: 600px) {
  ...
  .layer
  {
    background: #FFFFFF;
    box-shadow: 0px 0px 25px #E4EAF4;
    border-radius: 20px 20px 140px 20px !important;
  }
.sfont{
  font-size: 0.80rem;
}
